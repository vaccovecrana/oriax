  ...
  static {
    ...
    describe("Graph dependency traversal", () -> {
      it("Can find strongly connected nodes (Kosaraju-Sharir)", () -> {
        OxVtx<Integer> v0 = new OxVtx<>("0", 0);
        OxVtx<Integer> v1 = new OxVtx<>("1", 1);
        OxVtx<Integer> v2 = new OxVtx<>("2", 2);
        OxVtx<Integer> v3 = new OxVtx<>("3", 3);
        OxVtx<Integer> v4 = new OxVtx<>("4", 4);
